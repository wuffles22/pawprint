...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($error)) {
        $stmt = $pdo->prepare("UPDATE pets SET name = ?, breed = ?, age = ?, description = ?, status = ?, image = ? WHERE id = ?");
        if ($stmt->execute([$name, $breed, $age, $description, $status, $image_name, $pet_id])) {
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="age" class="form-control" value="<?= htmlspecialchars($pet['age']) ?>" min="0" required>
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <?php if (!empty($pet['image'])): ?>
                                        <div class="mb-2">
                                            <img src="../uploads/pets/<?= htmlspecialchars($pet['image']) ?>" class="img-fluid rounded" style="max-height: 200px;">
                                        </div>
                                    <?php else: ?>
